...
class CopyBrowser(unittest.TestCase):
    ...
    def test_report_replay_and_ide_load_new_copy_bundles(self):
        ...
        self.assertTrue({'training-demo-v1.js','review-copy-v1.js','market-copy-v1.js','studio-demo-v1.js'}<=loaded or {'training-quality-v1.js','review-quality-v1.js','market-quality-v1.js','studio-demo-v1.js'}<=loaded or {'training-quality-v1.js','review-quality-v1.js','market-refine-v1.js','studio-demo-v1.js'}<=loaded,loaded)
